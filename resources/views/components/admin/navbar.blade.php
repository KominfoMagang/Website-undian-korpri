<header class="navbar navbar-expand-md d-print-none">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <!-- Logo seharusnya mengarah ke dashboard -->
            <a href="{{ route('admin.dashboard') }}" class="text-decoration-none">
                <div class="d-flex align-items-center">
                    ...
                    <img src="/static/images/logoKotaTasik.png" alt="Logo Kota Tasikmalaya"
                        class="navbar-brand-image img-hover-zoom me-3"
                    ...
                    <div class="d-none d-sm-block text-start lh-1">
                        ...
                        <div class="fw-bolder text-reset text-uppercase"
            ...
            <div class="container-xl">
                <div class="d-flex justify-content-between align-items-center w-full">
                    <ul class="navbar-nav flex-row gap-3">
                        ...
                        <li
                            class="nav-item {{ request()->routeIs('admin.coupon') ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item {{ request()->routeIs('admin.participant*') ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item {{ request()->routeIs('admin.reward-config') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.reward-config') }}"
                                wire:navigate>
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon" width="24" height="24"
                        ...
                        <!-- TAUTAN BARU: MANAJEMEN KATEGORI -->
                        <li class="nav-item {{ request()->routeIs('admin.category-config') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.category-config') }}" wire:navigate>
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        <path
                                            d="M14 10h1a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-1a2 2 0 0 1 -2 -2v-2a2 2 0 0 1 2 -2z" />
                                        <path
                                            d="M17 10v6a2 2 0 0 1 -2 2h-6a2 2 0 0 1 -2 -2v-6a2 2 0 0 1 2 -2h6a2 2 0 0 1 2 2z" />
                                        <path
                                            d="M10 10v6a2 2 0 0 1 -2 2h-6a2 2 0 0 1 -2 -2v-6a2 2 0 0 1 2 -2h6a2 2 0 0 1 2 2z" />
                                        <path
                                            d="M17 10h1a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-1a2 2 0 0 1 -2 -2v-2a2 2 0 0 1 2 -2z" />
                                    </svg>
                                </span>
                                <span class="nav-link-title ms-1">Manajemen Kategori</span>
                            </a>
                        </li>

                        <li
                            class="nav-item {{ request()->routeIs('admin.store') ? 'active' : '' }}">
                    ...
                    <div class="d-flex align-items-center gap-2 ms-auto d-print-none">
                        ...
                        <a href="{{ route('slot-machine.undian') }}" target="_blank"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-dice me-2"
                        ...
                        <button class="btn btn-danger d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-logout me-2"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor" fill="none" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none">
